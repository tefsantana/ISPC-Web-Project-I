"""
Django settings for VIRTUAL_TRENDS project.
...
SECRET_KEY = 'django-insecure-!$wq_mqvaag3$dt-d9fo)5_@uxaz(o1_=+3au!pt=ngej%887-'
...
WSGI_APPLICATION = 'VIRTUAL_TRENDS.wsgi.application'
